...
export default function Home() {
    return (
        <div className='home'>
            <Network />
            <div className='ml-[calc(15%*var(--small-mult))] mr-[calc(15%*var(--small-mult))] pt-5 pb-15 pl-[5%] pr-[5%] mask-x-from-95% bg-[#ffffff33] backdrop-blur-md rounded-xl'>
                ...
                <div className='pl-10 pr-10 pt-5 pb-5'>
                    <img src='/img/transitmap_screenshot_1.png' alt='Map of Montréal. There are dots on the map to represent buses. One dot is selected. A box displays basic information on the bus, such as line number, bus ID, speed, occupancy and last update time.' className='pb-3'/>
